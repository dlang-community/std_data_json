...
{name: 'stdx.data.json.lexer.JSONString.anyValue', kind: "functiondeclaration", path: './stdx/data/json/lexer/JSONString.anyValue.html', attributes: ["pure", "nothrow", "property", "nogc", "safe", "const"]},
...
{name: 'stdx.data.json.lexer.JSONString.this', kind: "functiondeclaration", path: './stdx/data/json/lexer/JSONString.this.html', attributes: ["pure", "nothrow", "ref", "nogc", "safe"]},
...
{name: 'stdx.data.json.lexer.JSONToken.boolean', kind: "functiondeclaration", path: './stdx/data/json/lexer/JSONToken.boolean.html', attributes: ["pure", "nothrow", "property", "nogc", "trusted", "const"]},
...
{name: 'stdx.data.json.lexer.JSONToken.kind', kind: "functiondeclaration", path: './stdx/data/json/lexer/JSONToken.kind.html', attributes: ["pure", "nothrow", "property", "nogc", "safe", "const"]},
...
{name: 'stdx.data.json.lexer.JSONToken.number', kind: "functiondeclaration", path: './stdx/data/json/lexer/JSONToken.number.html', attributes: ["pure", "nothrow", "property", "nogc", "trusted", "const"]},
{name: 'stdx.data.json.lexer.JSONToken.opEquals', kind: "functiondeclaration", path: './stdx/data/json/lexer/JSONToken.opEquals.html', attributes: ["nothrow", "trusted", "const"]},
{name: 'stdx.data.json.lexer.JSONToken.string', kind: "functiondeclaration", path: './stdx/data/json/lexer/JSONToken.string.html', attributes: ["pure", "nothrow", "property", "nogc", "trusted", "const"]},
{name: 'stdx.data.json.lexer.JSONToken.toHash', kind: "functiondeclaration", path: './stdx/data/json/lexer/JSONToken.toHash.html', attributes: ["nothrow", "trusted", "const"]},
